// src/routes/front/center/metro/mw.js
'use strict';
...
export function prepareMetro(req, res, next) {
  ...
  sx.pid = PID.REQ_RECEIVED; // 기존 nationwide와 동일 PID 사용
  sx.cid = cid;

  console.log('[REQ][CENTER_METRO]', sx);
