// src/routes/front/center/subregion/mw.js
'use strict';
...
/**
 * /api/front/center/subregion 공통 미들웨어
 * - CID 세팅
 * - [REQ] 로그 출력
 */
export function prepareSubregion(req, res, next) {
  ...
  console.log('[REQ][CENTER_SUBREGION]', sx);
